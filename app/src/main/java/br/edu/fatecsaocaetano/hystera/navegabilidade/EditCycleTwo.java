...
public class EditCycleTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_editarciclo);
        ...
        seekBar.setOnSeekBarChangeListener(new CircularSeekBar.OnCircularSeekBarChangeListener() {
            ...
            public void onProgressChanged(CircularSeekBar circularSeekBar, float progress, boolean fromUser) {
                ...
                if (dias > 38 && !longoMensagem) {
                    Toast.makeText(EditCycleTwo.this, "Ciclo muito longo, é importante consultar um especialista", Toast.LENGTH_LONG).show();
                    longoMensagem = true;
                    diasTextView.setText(dias + " dias");
                } else if (dias < 15 && !curtoMensagem) {
                    Toast.makeText(EditCycleTwo.this, "Ciclo muito curto, é importante consultar um especialista", Toast.LENGTH_LONG).show();
                    curtoMensagem = true;
                    diasTextView.setText(dias + " dias");
                } else {
                    diasTextView.setText(dias + " dias");
    ...
    private void saveCycle(Cycle ciclo) {
        ...
        cycleRef.set(ciclo)
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent intent = new Intent(EditCycleTwo.this, TimeLine.class);
